...
For the first image, the model is relatively sure that this is a Children Crossing sign (probability of 0.96) but the image is a double curve. The top five soft max probabilities were:
...
| Probability         	|     Prediction	        					| 
|:---------------------:|:---------------------------------------------:| 
| 9.99853373e-01      	| General caution								| 
